...
export default function MindMap() {
  ...
  const definitionsNode: Definition[] = [

    {nodeId:1, definicionId:1, text:"El ser humano pretende la explicacion de todo lo que lo rodea, a diferencia de los animales, la finalidad es la manera en que el hombre pretende abordarla, no solo para explicarla sino para transformarla en su beneficio.", li:[]},
    ...
    {nodeId:11, definicionId:11, text:"Una investigacion es un proceso sistematico organizado y objetivo cuyo proposito es responder a una pregunta o hipotesis y asi aumentar el conocimiento y la informacion sobre algo desconocido, se caracterisa por ser:", li:[{1:"Empirica"},{2:"Sistematica"},{3:"Controlada"},{4:"Hipotesis"}]},
    ...
    {nodeId:13, definicionId:13, text:"Al realizar un trabajo de investigacion se puede presentar diversos obstaculos que pueden retrasar su avance o conclusion. Por lo general, esos obstaculos pueden ser de caracter metodologico, en donde el investigador se desvie del objetivo principal a desarrollar de ahi la importancia que se tenga en saber cual es el objetivo y los especificos, asi como la delimitacion temporal y espacial del trabajo, pues lo contrario llevaria a desarrollar temas que no se ajustan a dichos objetivos.",li:[]},
    {nodeId:15, definicionId:14, text:"Existen varios tipos de conocimiento", li:[{1:"Cientifico"},{2:"Vulgar"},{3:"Filosofico-Cientifico"},{4:"Empirico"},{5:"Filosofico-empirico"},{6:"Filosofico-Teologico"},{7:"Filosofico-Intuitivo"},{8:"Filosofico"},{9:"Declarativo"},{10:"Explicito"},{11:"Tactico"}]},
  ...
  return (
    ...
    <header className="text-center p-4 border-2">
      <h1 className="text-2xl font-bold p-2">Mapa Mental</h1>
    ...
    <main className="relative min-w-300 min-h-300 overflow-auto bg-indigo-500 border-6 m-6 flex justify-center items-center">
       ...
       {/* Nodo central */}
        ...
        return (
          <div
            ...
            style={{
            transform: `translate(calc(10% + ${32 * Math.cos((index * 360 / nodes.length) * (Math.PI / 180))}rem), calc(20% + ${32 * Math.sin((index * 360 / nodes.length) * (Math.PI / 180))}em))`
          }}
      ...
      {selectedDefinition && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          ...
          >
            ...
            { selectedDefinition.li.length > 0 && (
              <ul className="space-y-2">
                {selectedDefinition.li.map((item, idx) => (
